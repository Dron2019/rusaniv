    ...
    var markersData = [
        {
            ...
            position: { lat: 50.442111, lng:30.607244},
            type: 'main',
        ...
        {
            content: `Відділ продажу`,
            position: { lat: 50.440084,   lng: 30.608817, },
            type: 'sale',
            icon: { url: markersAdresses.sale,scaledSize: buildLogoSize,}
        },
        // {
        ...
        { content: `ТРЦ Комод`, position: { lat: 50.453278,  lng: 30.598447 }, type: 'shop', icon: { url: markersAdresses.shop,scaledSize: defaultMarkerSize,}},
        { content: `ТРЦ Silver Breeze`, position: { lat: 50.428686,  lng: 30.593379}, type: 'shop', icon: { url: markersAdresses.shop,scaledSize: defaultMarkerSize,}},
