...
/**tabs switch */
const tabsButtons = document.querySelectorAll('.filter-tab-nav-btn');
tabsButtons.forEach(tab => {
        tab.addEventListener('click', function(evt) {
            document.querySelector('.filter-tab-nav-btn--current').classList.remove('filter-tab-nav-btn--current');
            tab.classList.add('filter-tab-nav-btn--current');
            document.querySelector(`.js-filter-result-block-tab.active`).classList.remove('active');
            document.querySelector(`.js-filter-result-block-tab[data-index='${tab.dataset.index}']`).classList.add('active');
        });
    })
    /**tabs switch end*/